...
export declare type geolocationCollection = {description: {$id: "geolocation",properties: {contry: {type: "string"},state: {type: "string"},district: {type: "string"},street: {type: "string"},number: {type: "string"},complement: {type: "string"},zipcode: {type: "string"}},icon: "globe",required: ["contry","state","district","street","number","zipcode"],presets: ["crud"]},functions: {get: typeof get,getAll: typeof getAll,insert: typeof insert,remove: typeof remove},exposedFunctions: {get: true,getAll: true,insert: true,remove: true}}
